...
<head>
    ...
    <body>
		   ...
		   .nav-item ul li:hover{
            ...
            <nav class="pivot grid" style="margin-top:30px">
                <ul class="nav">
					...
					<li class="nav-item">
						<a class="nav-item-link" href="#">مشاهده اطلاعات</a>
						<ul>
						<a href="showAllPersons.php"><li>اطلاعات افراد</li></a>
						<a href="showAllMarries.php"><li>اطلاعات ازدواج</li></a>
						</ul>
					</li>
                    <li class="nav-item">
						<a class="nav-item-link" href="#">ثبت اطلاعات</a>
						<ul>
						<a href="addNewPerson.php"><li>ثبت اطلاعات فرد جدید</li></a>
						<a href="addNewMarryInfo.php"><li>ثبت اطلاعات ازدواج</li></a>
						</ul>
					</li>
					<li class="nav-item"><a class="nav-item-link" href="../users/profile.php">پنل کاربر عادی</a></li>
					<?php  
		...
		<div class="content pivot grid w1">
			<div class="full12 w2">
				<div class="block grid12 w3">
